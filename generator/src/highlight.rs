...
pub fn get_highlights() -> Vec<Highlight> {
    return vec![
        ...
        hi!(rainbowParensShell16, red, -, -, None),
        hi!(rainbowParensShell15, pink, -, -, None),
        hi!(rainbowParensShell14, purple, -, -, None),
        hi!(rainbowParensShell13, blue, -, -, None),
        hi!(rainbowParensShell12, cyan, -, -, None),
        hi!(rainbowParensShell11, green, -, -, None),
        hi!(rainbowParensShell10, yellow, -, -, None),
        hi!(rainbowParensShell9, orange, -, -, None),
        hi!(rainbowParensShell8, red, -, -, None),
        hi!(rainbowParensShell7, pink, -, -, None),
        hi!(rainbowParensShell6, purple, -, -, None),
        hi!(rainbowParensShell5, blue, -, -, None),
        hi!(rainbowParensShell4, cyan, -, -, None),
        hi!(rainbowParensShell3, green, -, -, None),
        hi!(rainbowParensShell2, yellow, -, -, None),
        hi!(rainbowParensShell1, orange, -, -, None),
    ];
}
